# -*- coding: utf-8 -*-
#
# behave documentation build configuration file, created by sphinx-quickstart
# on Tue Nov 29 16:33:26 2011.
#
...
# documentwidth (CSS length): Width of the document (without sidebar), default
# 50em.
...
html_theme_options = {
    # 'bodyfont': '"Ubuntu", sans-serif', # (CSS font family): Font for normal
    # text.
